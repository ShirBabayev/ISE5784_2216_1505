...
/**
 * A class that represents a vector by a point with 3 coordinates and provides
 * various operations on the vector
 * 
...
public class Vector extends Point {
	...
	/**
	 * A constructor that receives 3 double points and initializes them with the 3
	...
	/**
	 * A constructor that accepts a point with 3 coordinates and initializes the
	...
	/**
	 * Calculating the length of the vector - the distance from the point to the
	 * origin of the axes in the square
	 * 
