...
import primitives.*;
/**
 * A class that represents point lighting - lighting that comes from a point and spreads around
 */
public class PointLight extends Light implements LightSource {
	...
	/**
	 * A function that returns us the direction normalized vector between the starting point of the light and a certain point
	 * @param p is a point within the scene
	 * @return normalized vector between the point of origin of the light and the point
	 */
	public Vector getL(Point p) {return p.subtract(position).normalize();}
