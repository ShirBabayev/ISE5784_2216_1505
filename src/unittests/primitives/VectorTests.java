...
public class VectorTests {
	...
	void testConstructors() {
		...
		/*
		 * TC01: Checks exception when creating vector 0 with the parameters (0,0,0)
		 */
		...
		/*
		 * TC02: Checks exception when creating vector 0 with the parameter (Double3)
		 */
	...
	void testLengthSquared() {
		...
		/*
		 * TC03 Checks if the squared length of the vector did return a correct result
		 */
	...
	void testLength() {
		...
		// ============ Equivalence Partitions Tests ==============
		/* TC04 Checks if the length of the vector did return a correct result */
	...
	void testAddVector() {
		...
		// =============== Boundary Values Tests ==================
		/*
		 * TC05: Checks whether adding the opposite of itself to a vector throws an
		...
		/* TC06: Checks if adding 2 vectors returns a correct result */
	...
	void testsubtractVector() {
		...
		/*
		 * TC08: Checks if subtracting a vector from itself throws an error because a
	...
	void testScale() {
		...
		/*
		 * TC09: Checks that multiplying a vector by a scalar returns a correct result
		 */
		...
		/*
		 * TC10: Checks that multiplying a vector by a scalar 0 throw an exception
	...
	void testDotProduct() {
		...
		/* TC11: Checks if a scalar product of perpendicular vectors returns 0 */
		assertEquals(0, v1.dotProduct(v3), DELTA, "ERROR: dotProduct() for orthogonal vectors is not zero");

		// ============ Equivalence Partitions Tests ==============

		/* TC12: Checks if a scalar product of vectors returns a correct result */
	...
	void testCrossProduct() {
		...
		/*
		 * TC13: Checks if an error is thrown when doing vector multiplication between
		 * parallel vectors
		 */
		assertThrows(Exception.class, () -> v1.crossProduct(v2),
				"ERROR: crossProduct() for parallel vectors does not throw an exception");
		/*
		 * TC14: orthogonal vectors
		 */
		Vector vr = v1.crossProduct(v3);
		// Checks that the vector product takes into account the 90C angle between the
		// orthogonal vectors
		assertEquals(vr.length(), v1.length() * v3.length(), DELTA,
				"ERROR: crossProduct() returns wrong result length");
		// Checks whether a dot product of 2 orthogonal vectors returns 0
		...
		/* TC16: Checks that cross product returns a correct result */
	...
	void testNormalize() {
		...
		/*
		 * TC18: Checks the normalize function
		 */
		// Checks that the function does return a vector of unit length
		assertEquals(1, u.length(), DELTA, "ERROR: the normalized vector is not a unit vector");
		// Checks that a vector returns in the 90c direction and not the reverse of the
		// vector itself
		assertFalse((v.dotProduct(u) < 0), "ERROR: the normalized vector is opposite to the original one");
		// Checks that an error is thrown when doing a crossProduct of 2 parallel
