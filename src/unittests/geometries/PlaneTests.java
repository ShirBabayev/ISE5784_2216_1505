...
class PlaneTests {
	...
	void testGetNormalPoint() {
		...
		assertEquals(v1, plane1.getNormal(pts[0]),
	...
	void testFindIntsersections(){
		...
		//assertNull( plane1.findIntersections(new Ray(new Vector(0,-3,3),Point.ZERO)),"parallel ray to plane does not return null ");
		//TC12: The ray in contained in the plane
		assertNull( plane1.findIntersections(new Ray(pts[0].subtract(pts[1]),pts[0])),"parallel ray to plane does not return null ");
		...
		assertNull( plane1.findIntersections(new Ray(v,pts[1])),"ray starts at some point in the plane does not return null ");
		//TC17: ray start at q - the point that represents the plane
		assertNull( plane1.findIntersections(new Ray(v,pts[0])),"ray start at q - the point that represents the plane does not return null ");
