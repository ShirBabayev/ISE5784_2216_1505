...
public class RenderTests {
	...
	/*
	  @Test 
	  public void basicRenderXml() { // enter XML file name and parse from
	  ...
	  Camera camera1 = camera.setImageWriter(new ImageWriter("xml render test",
	 1000, 1000)).build(); camera1.renderImage(); camera1.printGrid(100, new
	 Color(YELLOW)); camera1.writeToImage(); }
	 */
}
