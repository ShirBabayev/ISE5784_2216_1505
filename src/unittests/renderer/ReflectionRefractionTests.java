...
public class ReflectionRefractionTests {
	...
	public void customScene3() {
		scene.geometries.add(
				new Plane(new Point(0, -50, -100), new Vector(0, 1, 0)).setEmission(new Color(255, 255, 255))
						.setMaterial(new Material().setKd(0.5).setKs(0.3).setShininess(60)),
				new Triangle(new Point(-150, -150, -150), new Point(150, -150, -135), new Point(0, 150, -150))
						.setEmission(new Color(1, 1, 1))
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)),
				new Triangle(new Point(-50, -50, -15), new Point(50, -50, -35), new Point(0, 50, -50))
						.setEmission(new Color(RED)).setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(60)),
				new Sphere(new Point(-50, 25, -50), 30d).setEmission(new Color(GREEN))
						.setMaterial(new Material().setKr(0.3).setShininess(100).setKt(new Double3(0.5, 0, 0))),
				new Sphere(new Point(25, 15, -50), 30d).setEmission(new Color(BLUE))
						.setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30).setKt(0.6)));
